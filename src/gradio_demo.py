...
class SadTalker():
    ...
    def test(self, source_image, driven_audio, preprocess='crop', 
        ...
        if driven_audio is not None and os.path.isfile(driven_audio):
            ...
            audio_path = os.path.join(input_dir, 'idlemode_'+str(length_of_audio)+'.wav') ## generate audios from this new audio_path
            from pydub import AudioSegment
        ...
        if use_ref_video and ref_info == 'all': # full ref mode
            ...
            # if ref_video contains audios, set the audios from ref_video.
        ...
        if use_ref_video and ref_info == 'all':
            ...
            batch = get_data(first_coeff_path, audio_path, self.device, ref_eyeblink_coeff_path=ref_eyeblink_coeff_path, still=still_mode, \
                idlemode=use_idle_mode, length_of_audio=length_of_audio, use_blink=use_blink) # longer audios?
